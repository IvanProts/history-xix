          ...
          <Fade duration={2000} Easing='ease' autoplay arrows={false} className={styles.carusel}>
            {slideImages.map((fadeImage, index) => (
              <div className={styles.fade} key={index}>
                <p className={styles.text}>Сьогодні місто Львів є культурною столицею України з багатою історією, яка об’єднує представників різних націй, народів і культур. 
...
Не дивлячись на це, українці та їхні сусіди, домоглися деяких прав та свобод на землі яку населяли. Поштовхом для цього стала знаменита “Весна народів” 1848 року.
</p>
